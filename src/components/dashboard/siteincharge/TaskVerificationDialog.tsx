...
const TaskVerificationDialog = ({ onOpenChange, taskId }: TaskVerificationDialogProps) => {
  const [verificationStatus, setVerificationStatus] = useState<"approved" | "rejected" | "rework">("approved");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (verificationStatus !== "approved" && !notes) {
      toast.error("Please provide notes explaining the issues");
      return;
    }
    ...
    toast.success(`Task ${verificationStatus}`, {
      description: verificationStatus === "approved" 
        ...
        ? "The task has been rejected. Contractor has been notified."
