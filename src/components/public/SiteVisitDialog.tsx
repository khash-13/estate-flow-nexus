...
export function SiteVisitDialog({ open, onOpenChange, onSubmit, projectName }: SiteVisitDialogProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} required placeholder="Enter your full name" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} required placeholder="Enter your phone number" type="tel" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
